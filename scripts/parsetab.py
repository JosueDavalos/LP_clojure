...
_lr_productions = [
  ...
  ('valor -> cadena','valor',1,'p_valor','implementation_nico.py',50),
  ('valor -> valor','valor',1,'p_valor','implementation_nico.py',51),
  ('cadena -> STRING','cadena',1,'p_cadena','implementation_nico.py',55),
  ('cadena -> PAR_IZQ STR STRING STRING PAR_DER','cadena',5,'p_cadena','implementation_nico.py',56),
  ('booleano -> TRUE','booleano',1,'p_booleano','implementation_nico.py',60),
  ('booleano -> FALSE','booleano',1,'p_booleano','implementation_nico.py',61),
  ('numero -> ENTERO','numero',1,'p_numero','implementation_nico.py',65),
  ('numero -> FLOTANTE','numero',1,'p_numero','implementation_nico.py',66),
]
